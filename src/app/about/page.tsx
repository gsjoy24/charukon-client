...
export const metadata: Metadata = {
	title: "About Us | Charukon",
	description:
		"Charukon is a trusted online retail platform dedicated to offering the finest products at unbeatable prices."
};
	...
	return (
		<Container maxWidth='md' sx={{ py: 4 }}>
			<Box mb={4}>
				...
				<Typography variant='body1' sx={{ color: "text.secondary" }}>
					At Charukon, our core mission is to address customer problems and prioritize their needs with unwavering
				...
				<Typography variant='body1' sx={{ color: "text.secondary" }}>
					Phone: +8801766892662
					<br />
					Email: <Link href='mailto:Charukonbd@gmail.com'> Charukonbd@gmail.com</Link>
				</Typography>
			</Box>
		</Container>
	);
